#!/usr/bin/env bash
# Transcript and hook-input JSON generators for Anvil stop-hook tests
#
# The stop hook reads:
...
create_transcript() {
  ...
  for msg in "$@"; do
    # Use jq for proper JSON escaping (handles newlines, quotes, etc.)
    local json_text
...
# (handles newlines and special chars better for complex test cases)
